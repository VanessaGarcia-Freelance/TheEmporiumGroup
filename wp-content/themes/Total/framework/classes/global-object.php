...
class WPEX_Global_Theme_Object {
	...
	private function menu_cart_style() {
		...
		if ( ! WPEX_WOOCOMMERCE_ACTIVE || ! wpex_get_mod( 'woo_menu_icon', true ) ) {
			return;
		}
	...
	private function post_slider_position() {
		...
		// Apply filters and return
		return apply_filters( 'wpex_post_slider_position', $position );
	...
	private function toggle_bar_content_id() {
		return apply_filters( 'wpex_toggle_bar_content_id', wpex_get_mod( 'toggle_bar_page' ) );
	}
