...
function wpex_enqueue_google_font( $font) {
	...
	// Enqueue style
	wp_enqueue_style(
		'wpex-google-font-'. $handle, '//fonts.googleapis.com/css?family='. str_replace(' ', '%20', $font ) .':100italic,200italic,300italic,400italic,600italic,700italic,800italic,900italic,900,800,700,600,500,400,300,200,100'. $subset,
		false,
		false,
		'all'
	);
