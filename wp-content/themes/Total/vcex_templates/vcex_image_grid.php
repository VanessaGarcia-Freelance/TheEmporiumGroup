...
if ( ! empty ( $attachment_ids ) ) :
	...
	if ( $my_query->have_posts() ) :
		...
		// Lightbox class
		if ( 'true' == $lightbox_gallery ) {
			$ligtbox_class = 'wpex-lightbox-group-item';
		} else {
			$ligtbox_class = 'wpex-lightbox';
		}
					...
					<figure class="<?php echo $figure_classes; ?>">
						...
						<?php endif; ?>
							...
							if ( 'lightbox' == $thumbnail_link ) :
								...
								<a href="<?php echo $lightbox_url; ?>" title="<?php echo $post->alt; ?>" class="vcex-image-grid-entry-img <?php echo $ligtbox_class; ?>"<?php echo $atts['lightbox_data']; ?>>
									<?php
									// Display image
									echo $post->thumbnail; ?>
									<?php
