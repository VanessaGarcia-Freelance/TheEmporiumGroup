...
class WPEX_Theme_Setup {
	...
	public function __construct() {
		...
		// Define globals
		global $wpex_theme, $wpex_theme_mods, $wpex_admin_help_tabs;
		...
		// Add admin help tabs?
		$wpex_admin_help_tabs = apply_filters( 'wpex_admin_help_tabs', true );
	...
	public function constants() {
		...
		// Theme version
		define( 'WPEX_THEME_VERSION', '3.1.1' );

		// Visual Composer supported version
		define( 'WPEX_VC_SUPPORTED_VERSION', '4.7.4' );
	...
	public function include_functions() {
		...
		if ( wpex_get_mod( 'blog_dash_thumbs', true ) ) {
	...
	public static function global_object() {
		...
		$wpex_theme = apply_filters( 'wpex_global_theme_object', $wpex_theme );
	...
	public static function add_theme_support() {
		...
		if ( in_array( wpex_get_mod( 'mobile_menu_toggle_style', 'icon_buttons' ), array( 'icon_buttons', 'icon_buttons_under_logo' ) ) ) {
			$menus['mobile_menu'] = __( 'Mobile Icons', 'wpex' );
		}
	...
	public static function localize_array() {
		...
		if ( $sticky_header ) {
			...
			$array['shrinkHeaderLogoHeight'] = wpex_get_mod( 'fixed_header_shrink_logo_height', 50 );
		}
