...
if ( ! class_exists( 'WPEX_Custom_JS' ) ) {
	class WPEX_Custom_JS {
				...
				<div>
					<form method="post" action="options.php">
						...
						<table class="form-table">
							<tr valign="top">
								<td style="padding:0;">
									<textarea rows="40" cols="50" id="wpex_custom_js" style="display:none;" name="wpex_custom_js"><?php echo wpex_get_mod( 'custom_js', false ); ?></textarea>
									<pre id="wpex_custom_js_editor" style="width:100%;height:800px;font-size:14px;    border: 1px solid #BABABA;"><?php echo wpex_get_mod( 'custom_js', false ); ?></pre>
								</td>
							</tr>
						</table>
						<?php submit_button(); ?>
		...
		public static function output_js() {
			$output = '';
			if ( $js = wpex_get_mod( 'custom_js', false ) ) { ?>
				<!-- CUSTOM JS -->
