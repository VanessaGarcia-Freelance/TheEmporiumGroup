	...
	class WPEX_User_Actions {
		...
		public function create_admin_page() { ?>
			...
			<div class="wrap wpex-custom-actions-admin-wrap">
				...
				<h1 style="padding-right:0;"><?php _e( 'Custom Actions', 'wpex' ); ?></h1>
				...
				if ( ! defined( 'WP_DEBUG' ) || WP_DEBUG == false ) { ?>
					...
					<div class="notice error">
						<p><?php _e( 'WP_DEBUG is disabled is currently disabled. It is highly recommended to enable it before adding action hooks incase you make a PHP error.', 'wpex' ); ?></p>
					</div>
						...
						<div id="post-body" class="metabox-holder columns-2">
							...
							<div id="post-body-content">
											...
											foreach ( $hooks as $hook ) {
												...
												<div class="postbox closed">
													...
													<div class="inside">
														...
														<p>
															<label><?php _e( 'Code', 'wpex' ); ?></label>
															<textarea placeholder="<?php esc_attr_e( 'Enter your custom action here&hellip;', 'wpex' ); ?>" name="wpex_custom_actions[<?php echo $hook; ?>][action]" rows="10" cols="50" style="width:100%;" class="wpex-textarea"><?php echo esc_textarea( $action ); ?></textarea>
														</p>

														<p class="clr">
															<label><?php _e( 'Enable PHP', 'wpex' ); ?></label>
															<input name="wpex_custom_actions[<?php echo $hook; ?>][php]" type="checkbox" value="" class="wpex-enable-php" <?php checked( $php, true ); ?>>
														</p>

														<p class="clr">
															<label><?php _e( 'Priority', 'wpex' ); ?></label>
															<input name="wpex_custom_actions[<?php echo $hook; ?>][priority]" type="number" value="<?php echo $priority; ?>" class="wpex-priority">
														</p>
								...
								<div id="postbox-container-1" class="postbox-container">
									<div class="postbox">
										<h3 class='hndle'><span><span class="dashicons dashicons-flag" style="margin-right:7px;"></span><?php _e( 'Important PHP Notice', 'wpex' ); ?></span></h3>
										<div class="inside">
											<p><?php _e( 'If you have enabled PHP for any action you MUST wrap your code in PHP tags. The theme will use the eval() function for outputting your PHP. Please be aware of the possibly security vulnerabilities this entails.', 'wpex' ); ?></p>
											<a href="http://php.net/manual/en/function.eval.php" title="<?php _e( 'Learn More', 'wpex' ); ?>" target="_blank" class="button button-secondary"><?php _e( 'Learn More', 'wpex' ); ?></a>
										</div><!-- .inside -->
									</div><!-- .postbox -->
									<div class="postbox">
										<h3 class='hndle'><span><span class="dashicons dashicons-upload" style="margin-right:7px;"></span><?php _e( 'Save Your Actions', 'wpex' ); ?></span></h3>
										<div class="inside">
											<p><?php _e( 'Click the button below to save your custom actions.', 'wpex' ); ?></p>
											<?php submit_button(); ?>
										</div><!-- .inside -->
									</div><!-- .postbox -->
