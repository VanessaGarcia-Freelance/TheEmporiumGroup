...
<div class="<?php echo esc_attr( $wrap_classes ); ?>"<?php vcex_unique_id( $unique_id ); ?>>
    ...
    if ( $button_url && $button_text ) : ?>
        ...
        <div class="vcex-callout-button">
            <a href="<?php echo $button_url; ?>" class="theme-button <?php echo $button_style; ?> <?php echo $button_color; ?> animate-on-hover" title="<?php echo $button_text; ?>"<?php echo $button_target; ?><?php echo $button_rel; ?><?php echo $button_inline_style; ?>>
                <span class="theme-button-inner" <?php echo $button_border_radius; ?>>
                    <?php
